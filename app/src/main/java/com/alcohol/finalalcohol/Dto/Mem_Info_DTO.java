...
public class Mem_Info_DTO {
	...
	public Mem_Info_DTO(int mem_id, String mem_email, String mem_name, String mem_nickname, int mem_body, int mem_alcohol_type, int mem_flavor,
						int mem_smell, int mem_alcohol_bv, String mem_birth, String mem_adult, String mem_subs, String mem_social_type, String mem_kakao,
						String mem_kakao_nickname, String mem_naver, String mem_naver_nickname, String mem_naver_id, String mem_join_dt,
						String mem_profile_imgname, String mem_profile_imgpath, String mem_address, String mem_post, String mem_gender, String mem_phone, String mem_card,
						String mem_event_dt_brew, String mem_event_dt_mini) {
		this.mem_id = mem_id;
