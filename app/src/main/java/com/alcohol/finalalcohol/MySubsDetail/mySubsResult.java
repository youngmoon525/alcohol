...
public class mySubsResult extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.intent_my_subsresult);
        ...
        //adapter 객체 생성
        adapter = new mySubsDetailAdapter(mySubsList, mySubsResult.this);


        //adapter 에 담을 dto 의 list 를 서버에서 가져옴
        stateBundle.putString("page","Result");
