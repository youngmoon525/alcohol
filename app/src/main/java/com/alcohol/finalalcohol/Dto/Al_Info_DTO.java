...
public class Al_Info_DTO {
    private String al_name, al_manufacturer, al_material, al_vol, al_body, al_alcohol_type, al_flavor, al_smell,
    ...
    public Al_Info_DTO(int al_id, String al_name, String al_alcohol_type,
                       String al_flavor, String al_smell, String al_real_alcohol_bv, String al_imgpath){
        this.al_id = al_id;
